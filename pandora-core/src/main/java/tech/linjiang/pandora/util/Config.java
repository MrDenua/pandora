...
public class Config {
  ...
  public static String getNetFilterStr(){
    return getSp().getString(KEY_NET_FILTER, "");
  }

  public static void setNetFilter(String filter) {
    getSp().edit().putString(KEY_NET_FILTER, filter).apply();
  }

  public static void setNetFilterEnable(boolean enable) {
    getSp().edit().putBoolean(KEY_NET_FILTER_ENABLE, enable).apply();
  }

  public static boolean getNetFilterEnable() {
    return getSp().getBoolean(KEY_NET_FILTER_ENABLE, false);
  }
